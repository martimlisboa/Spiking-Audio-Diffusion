...
class GradientNormalizingFunction(torch.autograd.Function):
    ...
    def backward(ctx, grads):
        ...
        # added this line because of a incongruence between devices in the model
        epsilon = torch.Tensor(epsilon).to(grads.device)
...
class NormalizedMultiTaskSplitter(nn.Module):
    ...
    def forward(self, x, perm = None):
        ...
        x_tuple = self.splitter.forward(x,perm = perm)
